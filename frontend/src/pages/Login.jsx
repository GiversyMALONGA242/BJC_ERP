...
const BACKEND = 'https://bjc-erp-backend.onrender.com'
    ...
    <div className="min-h-screen bg-gradient-to-br from-bjc-900 via-bjc-700 to-bjc-500 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              {users.length > 0 ? (
                ...
                <input className="input" placeholder="Nom utilisateur"
                  value={selected} onChange={e => setSelected(e.target.value)} />
              )}
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1.5">Code acces</label>
          ...
          <p className="text-center text-xs text-gray-400 mt-4">ERP v2.1</p>
        </div>
      </div>
    </div>
  )
